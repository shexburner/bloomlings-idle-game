...
**Phase 5: Monetization** — IN PROGRESS (2 / 4 tasks done)
...
## What's Next: Phase 5 — Monetization (2 tasks remaining)

See `docs/roadmap.md` Phase 5: 6 remaining ad touchpoints (Sunbeam Boost, Dewdrop Garden, Lucky Sprout, Gate Assist, Boss Smash, Combo Keeper — each a thin consumer of `useRewardedAd("<unit>")` per the pattern established by `WelcomeBackModal`), and Dewdrop shop (`app/(tabs)/dewdrop-shop.tsx`).
